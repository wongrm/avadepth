...
incl_ava_defs={
  ...
  locDefs: {
    ...
    'CR': {
      ...
      "IW" : {
          ...
          "Sections" : {
              "BC_Sica" : {
                  "Form" : { "Title" : "Sicamous, BC", "Key" : "BC_Sica"},
                  "Names" : [""],
                  "Coords" : {"Lat":{"min" : 6586478, "max" : 6596334},"Lon":{"min" : -13249719,"max" : -13242435}}
              },
              "MB_Red" : {
                  "Form" : { "Title" : "Red River, MB", "Key" : "MB_Red"},
                  "Names" : [""],
                  "Coords" : {"Lat":{"min" : 6586478,"max" : 6596334},"Lon" : {"min" : -13249719,"max" : -13242435}}
              },
              "NT_Hay" : {
                  "Form" : {"Title" : "Hay River, NT","Key" : "NT_Hay"},
                  "Names" : [""],
                  "Coords" : {"Lat" : {"min" : 6586478,"max" : 6596334},"Lon" : {"min" : -13249719,"max" : -13242435}}
              },
              "NT_Mack" : {
                  "Form" : {"Title" : "Mackenzie River, NT","Key" : "NT_Mack"},
                  "Names" : [""],
                  "Coords" : {"Lat" : {"min" : 6586478,"max" : 6596334},"Lon" : {"min" : -13249719,"max" : -13242435}}
              }
          }
      ...
      "POV" : {
          "Form" : {"Title" : "Vancouver Harbour, BC","Order" : 2},
          "Coords" : {"Lat" : {"min" : 6316237, "max" : 6337717},"Lon" : {"min" : -13722084,"max" : -13670754}},
          // TODO
          "Sections" : {
              "POV_BI" : {
                  "Form" : {"Title" : "Burrard Inlet","Key" : "POV_BI"},
                  "Names" : [""],
                  "Coords" : {"Lat" : {"min" : 6311123,"max" : 6342847},"Lon" : {"min" : -13725424,"max" : -13667414}}
              },
              "POV_PT" : {
                  "Form" : {"Title" : "Port Terminal","Key" : "POV_PT"},
                  "Names" : ["Fraser Surrey Docks", "Centennial Pier","Lynnterm Westgate"],
                  "Coords" : {"Lat" : {"min" : 6311123,"max" : 6342847},  "Lon" : {"min" : -13725424,"max" : -13667414}}
              },
              "POV_FC" : {
              "Form" : {"Title" : "False Creek","Key" : "POV_FC"},
              "Names" : [""],
              "Coords" : {"Lat" : {"min" : 6311123,"max" : 6342847},"Lon" : {"min" : -13725424,"max" : -13667414}}
          }
        }
  ...
  "FR": {
    'Form':{'Title':'Fraser River, BC', 'Order':3},
    'Coords':{'Lat':{'min':6287000,'max':6352933},'Lon':{'min':-13730400,'max':-13510906}},
    'Sections':{
      'FRSA': {
        'Form': {'Title': "South Arm", 'Key': "FRSA"},
        'Names': ['Sand Heads to Fraser Surrey Docks', 'Sand Heads Entrance', 'Sand Heads Reach', 'Steveston Bend',
                  'Steveston Cut', 'Woodward Reach', 'Gravesend Reach', 'City Reach',
                  'Annieville - New West'],
        'Coords': {'Lat': {'min': 6287000, 'max': 6317590}, 'Lon': {'min': -13730400, 'max': -13669354}},
        'pwl': {'key': "South Arm"}
      },
      "POV_FSD" : {
        "Form" : { "Title" : "Port Terminal","Key" : "POV_FSD"},
        "Names" : ["Fraser Surrey Docks"],
        "Coords" : {"Lat": { "min" : 6311123,"max" : 6342847}, "Lon" : {"min": -13725424, "max" : -13667414}}
    },
      'FRNA': {
        'Form': {'Title': "North Arm", 'Key': "FRNA"},
        'Names': ['Point Grey to New Westminster', 'Point Grey', 'Iona', 'Musqueam',
                  'Sea Island', 'Marpole Basin', 'Mitchell Island', 'Mac-Blo', 'Byrne Road',
                  'Big Bend - Queens', 'Poplar Island'],
        'Coords': {'Lat': {'min': 6302401, 'max': 6318147}, 'Lon': {'min': -13724567, 'max': -13679776}},
        'pwl': {'key': "North Arm"}
      },
      'FRMA': {
        'Form': {'Title': "Main Arm", 'Key': "FRMA"},
        'Names': ['New Westminster to Fort Langley','Fort Langley to Mission', 'Queens Reach',
                  'Douglas Island', 'Bishops Reach', 'Derby Reach',
                  'Russel Reach','Russel Reach (Langley Bar)', 'Plumper Reach', 'Matsqui Island'],
        'Coords': {'Lat': {'min': 6290650, 'max': 6315727}, 'Lon': {'min': -13685417, 'max': -13610377}},
        'pwl': {'key': 'Main Arm'}
      },
      'FRSA_SC': {
        'Form': {'Title': "South Arm - Side Channel", 'Key': "FRSA_SC"},
        'Names': ['Ladner Sea Reach Overview','Annacis Channel','Gundersen Slough','Shoal Point - New West',
                  'Burr Landing Channel','Cannery Channel','Sea Reach','Ladner Reach',
                  'Canoe Pass','Ladner Harbour','Deas Slough',],
        'Coords': {'Lat': {'min': 6287000, 'max': 6317590}, 'Lon': {'min': -13730400, 'max': -13669354}}
      },
      'FRNA_SC': {
        'Form': {'Title': "North Arm - Side Channel", 'Key': "FRNA_SC"},
        'Names': ['Morey Channel - Middle Arm', 'Cowards Cove', 'Point Grey Scow Moorage',
                  'Deering Channel','Macdonald Slough','Mitchell Island North Channel','Tree Island Channel'],
        'Coords': {'Lat': {'min': 6302401, 'max': 6318147}, 'Lon': {'min': -13724567, 'max': -13679776}}
      },

	  'FRMA_SC': {
        'Form': {'Title': "Main Arm - Side Channel", 'Key': "FRMA_SC"},
        'Names': ['Bedford Channel','Douglas Island North Channel','Essondale Channel',
                  'Parsons Channel','Sapperton Channel'],
        'Coords': {'Lat': {'min': 6290650, 'max': 6315727}, 'Lon': {'min': -13685417, 'max': -13610377}}
      },

      'FRPR': {
        'Form':{'Title': "Pitt River",'Key': "FRPR"},
        'Names': [''],
        'Coords':{'Lat':{'min':6312424,'max':6352933},'Lon':{'min':-13669210,'max':-13633754}}
      },

      'FRUR': {
        'Form': {'Title': "Mission to Hope", 'Key': "FRUR"},
        'Names': [''],
  ...
  "WS" : {
      "Form" : {"Title" : "Waterway Structure","Order" : 4},
      "Coords" : {"Lat" : {"min" : 6289181,"max" : 6325119},"Lon" : {"min" : -13728265,"max" : -13569386}},
      "Sections" : {
          "WS_LFR" : {
              "Form" : {"Title" : "Lower Fraser River","Key" : "WS_LFR"},
              "Names" : ["North Arm Breakwater","North Arm Jetty","Steveston North Jetty",
                         "Steveston South Jetty No. 2","Albion Training Wall","Steveston Wingdams",
                         "Steveston Island Shearboom","Woodward Island Training Wall",
                         "Kirkland & Deas Island Bank Protection","Trifurcation Phase I Training Wall",
                         "Trifurcation Phase II Training Wall","Trifurcation Phase III Training Wall",
                         "Sapperton Wingdam No. 2 & No. 3","Sapperton V_Dyke"],
              "Coords" : {"Lat" : {"min" : 6309661,"max" : 6322555},"Lon" : {"min" : -13725650, "max" : -13714402}}
          },
          "WS_M2H" : {
              "Form" : {"Title" : "Mission to Hope", "Key" : "WS_M2H"},
              "Names" : ["Big & Middle Eddy Rock Groynes"],
              "Coords" : {"Lat" : {"min" : 6295882,"max" : 6302924},"Lon" : {"min" : -13593487,"max" : -13588166 }}
          },
          "WS_HR" : {
              "Form" : {"Title" : "Harrison River","Key" : "WS_HR"},
              "Names" : ["Harrison Mills CPR Bridge Shearboom","Harrison River Dykes V R W P",
                  "Harrison Hwy No.7 Bridge Shearboom", "Harrison Rapids Shearboom"],
              "Coords" : {"Lat" : {"min" : 6311285,"max" : 6325119},"Lon" : {"min" : -13579382,"max" : -13569386}}
          }
        }
      }
