          ...
          success: function(data){
            data.forEach(function(waterway){
                ...
                waterway.Sections.forEach(function(sec){
                    params[waterway.Key][Form][Sections][sec.Key][Form] = sec.Form;
                    params[waterway.Key][Form][Sections][sec.Key][Coords] = sec.Coords;
                    params[waterway.Key][Form][Sections][sec.Key][Locations] = sec.Locations;
                    if (sec.pwl){
                        params[waterway.Key][Form][Sections][sec.Key][pwl] = sec.pwl;
                    }
                })
            })
          }
